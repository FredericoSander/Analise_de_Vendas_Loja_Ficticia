...
"""
função para ler arquivos CSV de uma pasta específica e concatená-los em um único DataFrame.""

args: input_path(str): Caminho da pasta onde os arquivos CSV estão localizados.
returns: pd.DataFrame: DataFrame contendo os dados de todos os arquivos CSV.
"""
